  ...
  group('ToolExecutor', () {
    test('should have all required fields', () {
      final FunctionTool tool = FunctionTool(
        ...
        description: 'Test',
        parameters: <String, dynamic>{},
        function: (Map<String, dynamic> final args) async => 'result',
      );
    ...
    test('should execute tool by name', () async {
      final FunctionTool tool = FunctionTool(
        ...
        parameters: <String, dynamic>{},
        function: (final Map<String, dynamic> args) async => 'Hello, ${args['name']}!',
      );
      
      final ToolExecutor executor = ToolExecutor(tools: <Tool>[tool]);
      final result = await executor.execute('greet', <String, dynamic>{'name': 'Alice'});
