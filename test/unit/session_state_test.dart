...
void main() {
  group('SessionStatus', () {
    ...
    test('isActive should return correct value', () {
      ...
      const SessionStatus listening =
          SessionStatus(state: SessionState.listening);
      const SessionStatus processing =
          SessionStatus(state: SessionState.processing);
      const SessionStatus speaking =
          SessionStatus(state: SessionState.speaking);
